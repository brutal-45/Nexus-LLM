...
3. **Add** the upstream remote:
   ```bash
   git remote add upstream https://github.com/brutal-45/Nexus-LLM.git
   ```
...
1. Check if the bug has been reported in [Issues](https://github.com/brutal-45/Nexus-LLM/issues)
