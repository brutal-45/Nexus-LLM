...
[![CI](https://img.shields.io/github/actions/workflow/status/brutal-45/Nexus-LLM/ci.yml?branch=main)](https://github.com/brutal-45/Nexus-LLM/actions)
...
```bash
# After pip install -e .
nexus-llm                    # Start interactive chat
