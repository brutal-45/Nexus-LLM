...
DEFAULT_BINDINGS: list[KeyAction] = [
    ...
    # Editing
    KeyAction(
        "backspace", "delete_char", "Delete character before cursor", BindingMode.EMACS, "input"
    ),
    KeyAction(
        "delete", "delete_char_forward", "Delete character at cursor", BindingMode.EMACS, "input"
    ),
