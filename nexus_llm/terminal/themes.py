...
THEMES: Dict[str, Theme] = {
    "dark": Theme(
        ...
        system_text="dim yellow",
        error_text="bold red",
        success_text="bold green",
        info_text="dim",
        code_text="green",
        code_bg="default",
        border_color="blue",
    ...
    "light": Theme(
        ...
        system_text="dim magenta",
        error_text="bold red",
        success_text="bold green",
        info_text="dim",
        code_text="dark_green",
        code_bg="default",
        border_color="dark_blue",
        title_color="bold dark_red",
    ...
    "ocean": Theme(
        ...
        system_text="dim bright_cyan",
        error_text="bold bright_red",
        success_text="bold bright_green",
        info_text="dim bright_blue",
        code_text="bright_cyan",
        code_bg="default",
        border_color="bright_blue",
        title_color="bold bright_magenta",
    ...
    "sunset": Theme(
        ...
        assistant_text="bright_white",
        system_text="dim bright_red",
        error_text="bold red",
        success_text="bold green",
        info_text="dim yellow",
        code_text="bright_yellow",
        code_bg="default",
        border_color="bright_red",
        title_color="bold bright_red",
