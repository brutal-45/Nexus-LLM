...
def rgb(r: int, g: int, b: int) -> str:
    ...
    Returns:
        ANSI escape code string.
    """
    return f"\033[38;2;{_clamp_channel(r, 'red')};{_clamp_channel(g, 'green')};{_clamp_channel(b, 'blue')}m"
...
def bg_rgb(r: int, g: int, b: int) -> str:
    ...
    Returns:
        ANSI escape code string.
    """
    return f"\033[48;2;{_clamp_channel(r, 'red')};{_clamp_channel(g, 'green')};{_clamp_channel(b, 'blue')}m"
