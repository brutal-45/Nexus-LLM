...
import csv
import io
import json"""Output formatting for CLI commands."""
...
class OutputFormat(Enum):
    ...
    def from_string(cls, name: str) -> OutputFormat:
        ...
        try:
            ...
            raise ValueError(f"Unknown output format '{name}'. Valid: {valid}") from None
...
def _format_csv(data: Any, columns: Sequence[str] | None = None, **kwargs: Any) -> str:
...
def _format_table(data: Any, columns: Sequence[str] | None = None, **kwargs: Any) -> str:
...
def _format_markdown(data: Any, columns: Sequence[str] | None = None, **kwargs: Any) -> str:
