    ...
    def _load_builtins(self) -> None:
        ...
        builtins: List[Preset] = [
            ...
            Preset(
                ...
                description=(
                    "Optimised for code generation, debugging, and " "software engineering tasks."
                ),
                model_config={
                    "model": "claude-3-sonnet",
            ...
            Preset(
                ...
                description=(
                    "Optimised for creative writing, storytelling, " "and brainstorming sessions."
                ),
                model_config={
                    "model": "claude-3-opus",
                    "context_length": 8192,
            ...
            Preset(
                ...
                description=(
                    "Optimised for data analysis, summarisation, " "and structured reasoning."
                ),
                model_config={
                    "model": "claude-3-sonnet",
                    "context_length": 16384,
