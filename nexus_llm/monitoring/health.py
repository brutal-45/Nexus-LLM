...
class SystemHealth:
    ...
    def is_healthy(self) -> bool:
        ...
        return self.cpu_percent < 95.0 and self.memory_percent < 95.0 and self.disk_percent < 95.0
...
class HealthChecker:
    ...
    def check_health(self) -> HealthReport:
        ...
        all_healthy = (
            model_health.is_healthy and system_health.is_healthy and all(custom_results.values())
        )
    ...
    def check_system_health(self) -> SystemHealth:
        ...
        try:
            ...
            if torch.cuda.is_available():
                ...
                gpu_utilization_percent = (
                    gpu_mem_allocated / (gpu_props.total_mem / (1024**2))
                ) * 100
        ...
        return SystemHealth(
            ...
            gpu_utilization_percent=(
                round(gpu_utilization_percent, 1) if gpu_utilization_percent else None
            ),
        )
