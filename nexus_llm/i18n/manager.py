...
from nexus_llm.i18n.locale import BUILTIN_LOCALES, Locale
...
class I18nManager:
    ...
    def __init__(self, default_locale: str = "en") -> None:
        ...
        self._locales: Dict[str, Locale] = {loc.code: loc for loc in BUILTIN_LOCALES}
    ...
    def register_translations(self, locale_code: str, translations: Dict[str, Any]) -> None:
    ...
    def translate(self, key: str, **kwargs: Any) -> str:
        ...
        with self._lock:
            ...
            if template is None and locale != self._default_locale:
                template = self._translations.get(self._default_locale, {}).get(key)
    ...
    def _flatten(d: Dict[str, Any], parent_key: str = "", sep: str = ".") -> Dict[str, Any]:
        ...
        for k, v in d.items():
            ...
            if isinstance(v, dict):
                items.extend(I18nManager._flatten(v, new_key, sep=sep).items())
            else:
