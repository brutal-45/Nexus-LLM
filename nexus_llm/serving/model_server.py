...
class ModelServer:
    ...
    def health_check(self) -> HealthCheckResult:
        ...
        if not self._model:
            ...
            memory_mb > 0 and self._config.max_memory_mb and memory_mb > self._config.max_memory_mb
        ):
            status = HealthStatus.DEGRADED
    ...
    def _health_check_loop(self) -> None:
        ...
        while self._running:
            try:
                ...
                if (
                    self._last_activity
                    and self._config.idle_timeout > 0
                    and time.time() - self._last_activity > self._config.idle_timeout
