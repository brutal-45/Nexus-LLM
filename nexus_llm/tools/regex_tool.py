...
class RegexTool(BaseTool):
    r"""Tool for regular expression operations.
    ...
    def parameters(self) -> List[ToolParameter]:
        return [
            ToolParameter(
                ...
                required=True,
                choices=["match", "search", "findall", "sub", "split"],
            ),
            ToolParameter(
            ...
            ToolParameter(
                name="replacement",
                type=ParameterType.STRING,
                description="Replacement string for sub",
                required=False,
            ),
            ToolParameter(
                name="flags",
                type=ParameterType.STRING,
                description="Regex flags (e.g., IGNORECASE)",
                required=False,
            ),
        ]
