...
class UnitConverterTool(BaseTool):
    ...
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(
            name="unit_converter", description="Convert between measurement units", **kwargs
        )
    ...
    def parameters(self) -> List[ToolParameter]:
        return [
            ...
            ToolParameter(
                name="to_unit", type=ParameterType.STRING, description="Target unit", required=True
            ),
            ToolParameter(
                name="category",
                type=ParameterType.STRING,
                ...
                required=False,
                default="auto",
                choices=["auto", "length", "weight", "volume", "temperature"],
            ),
        ]
    ...
    def _convert(self, value: float, from_unit: str, to_unit: str, category: str) -> Dict[str, Any]:
        ...
        if category == "temperature" or (
            from_unit in ("c", "f", "k") and to_unit in ("c", "f", "k")
        ):
