    ...
    def parameters(self) -> List[ToolParameter]:
        return [
            ToolParameter(
                ...
                required=True,
                choices=["parse", "query", "to_dict", "validate"],
            ),
            ToolParameter(
                name="data", type=ParameterType.STRING, description="XML data string", required=True
            ),
            ToolParameter(
                name="xpath",
                type=ParameterType.STRING,
                description="XPath expression for queries",
                required=False,
            ),
        ]
