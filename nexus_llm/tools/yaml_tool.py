    ...
    def parameters(self) -> List[ToolParameter]:
        return [
            ToolParameter(
                ...
                required=True,
                choices=["parse", "stringify", "validate", "merge", "get_key"],
            ),
            ToolParameter(
                name="data",
                type=ParameterType.STRING,
                description="YAML data string",
                required=True,
            ),
            ToolParameter(
                name="key", type=ParameterType.STRING, description="Key to retrieve", required=False
            ),
            ToolParameter(
                name="merge_data",
                type=ParameterType.STRING,
                description="Second YAML for merging",
                required=False,
            ),
        ]
