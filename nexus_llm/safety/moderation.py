...
class ModerationPolicy:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "severity_thresholds": {a.value: s.value for a, s in self.severity_thresholds.items()},
...
class ContentModerator:
    ...
    def _moderate(
        ...
        if toxicity_result and toxicity_result.is_toxic:
            ...
            action = (
                policy.determine_action(toxicity_severity) if policy else ModerationAction.BLOCK
            )
            if action.value > final_action.value:
                final_action = action
            reasons.append(
    ...
    def get_config(self) -> Dict[str, Any]:
        ...
        return {
            "policies": {cat.value: policy.to_dict() for cat, policy in self._policies.items()},
