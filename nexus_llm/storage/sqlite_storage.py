...
class SQLiteStorage(StorageBackend):
    ...
    def save(self, key: str, value: Any) -> None:
        ...
        try:
            ...
            raise StorageError(f"Cannot serialise value for key {key!r}: {exc}") from exc
        ...
        try:
            ...
            conn.rollback()
            raise StorageError(f"Failed to save key {key!r}: {exc}") from exc
    ...
    def load(self, key: str) -> Any:
        ...
        try:
            ...
            raise StorageError(f"Corrupt JSON for key {key!r}: {exc}") from exc
