...
from nexus_llm.data.loader import PackedDataset, DataCollator, PackedSequence
from nexus_llm.data.processor import TextPreprocessor
from nexus_llm.data.processor import (
    LengthFilter, RepetitionFilter, LanguageFilter,
    QualityClassifier, DataQualityPipeline, QualityMetrics,
)
from nexus_llm.data.processor import ExactDeduplicator, MinHashLSHDeduplicator
...
class TestDeduplication:
    ...
    def test_minhash_similarity(self):
        from nexus_llm.data.processor import MinHasher
